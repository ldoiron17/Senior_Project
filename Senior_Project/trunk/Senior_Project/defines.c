...
struct MOTOR_T MOTOR1_X = {POSITIVE, 0, NO, FULLSTEP, STATE0, 0};

struct MOTOR_T MOTOR2_Y = {POSITIVE, 0, NO, FULLSTEP, STATE0, 0};

struct MOTOR_T MOTOR3_Z = {POSITIVE, 0, NO, FULLSTEP, STATE0, 0};
