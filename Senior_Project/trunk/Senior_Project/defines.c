...
volatile char *Gcode_request = "Please Enter Gcode Command:";
volatile char *ding = "\a";
...
volatile struct MOTOR_T MOTOR1_X = {POSITIVE, 0, NO, FULLSTEP, STATE0, 0, 1};

volatile struct MOTOR_T MOTOR2_Y = {POSITIVE, 0, NO, FULLSTEP, STATE0, 0, 1};

volatile struct MOTOR_T MOTOR3_Z = {POSITIVE, 0, NO, FULLSTEP, STATE0, 0, 1};
